...
var BaseSerializerContext = class {
  ...
  serializeSpecialReferenceValue(ref) {
    switch (ref) {
      ...
      case 5 /* AbortSignalConstructor */:
        return this.createFunction(
          ["a", "s"],
          "((s=(a=new AbortController).signal).a=a,s)"
        );
      case 6 /* AbortSignalAbort */:
        return this.createEffectfulFunction(
          ["s", "r"],
  ...
  serializeAbortSignalSync(node) {
    return this.assignIndexedValue(
      node.i,
      "AbortSignal.abort(" + this.serialize(node.f) + ")"
    );
  }
  serializeAbortSignalConstructor(node) {
    return this.assignIndexedValue(node.i, this.getConstructor(node.f) + "()");
  }
  serializeAbortSignalAbort(node) {
    return this.getConstructor(node.a[0]) + "(" + this.getRefParam(node.i) + "," + this.serialize(node.a[1]) + ")";
  }
  serialize(node) {
    try {
...
var BaseSyncParserContext = class extends BaseParserContext {
  ...
  parseAbortSignalSync(id, current) {
    return createSerovalNode(
      37 /* AbortSignalSync */,
      id,
      NIL,
          ...
          if (parsed) {
            this.onParse(
              createSerovalNode(
                ...
                NIL,
                [
                  this.parseSpecialReference(6 /* AbortSignalAbort */),
                  parsed
                ],
                NIL,
                NIL,
